...
export function chartAppPayloadFrom(
  output: Record<string, unknown> & McpChartAppPayload
): McpChartAppPayload {
  return {
    embedUrl: output.embedUrl,
...
export function mapAppPayloadFrom(
  output: Record<string, unknown> & McpMapAppPayload
): McpMapAppPayload {
  return {
    embedUrl: output.embedUrl,
